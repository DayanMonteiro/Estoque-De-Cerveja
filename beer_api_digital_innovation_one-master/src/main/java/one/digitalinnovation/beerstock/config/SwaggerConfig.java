...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Dayan Monteiro";
    private static final String CONTACT_GITHUB = "https://gtihub.com/DayanMonteiro";
    private static final String CONTACT_EMAIL = "dmsmamb@gmail.com";

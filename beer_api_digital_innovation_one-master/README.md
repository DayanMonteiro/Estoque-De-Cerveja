...
```
Por opão eu usei o Postman que é uma ferramenta que dá suporte à documentação das requisições feitas pela API

![Postman](https://github.com/DayanMonteiro/Estoque/blob/main/Postman.jpg)

A IDEA utilizada foi IntelliJ é um ambiente de desenvolvimento integrado.

![IntelliJ](https://github.com/DayanMonteiro/Estoque/blob/main/IntelliJ.jpg)
